...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.voxel_opacity_reg_start = 15_000
        self.voxel_opacity_reg_weight = 0.05
        self.voxel_prune_start = 25_000
        self.voxel_prune_interval = 1_000
        self.voxel_prune_threshold = 0.02
